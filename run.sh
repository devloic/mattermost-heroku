...
export CUSTOMIZATION__SITENAME=${CUSTOMIZATION__SITENAME:="Mattermost"}
export CUSTOMIZATION__DESCRIPTION=${CUSTOMIZATION__DESCRIPTION:=""}
...
export EMAIL_SETTINGS__INVITE_SALT=${EMAIL_SETTINGS__INVITE_SALT:="bjlSR4QqkXFBr7TP4oDzlfZmcNuH9YoS"}

export PUSH__SETTINGS__SEND_PUSH_NOTIFICATIONS=${PUSH__SETTINGS__SEND_PUSH_NOTIFICATIONS:=false}
export PUSH__SETTINGS__PUSH_NOTIFICATION_SERVER=${PUSH__SETTINGS__PUSH_NOTIFICATION_SERVER:=""}
export PUSH__SETTINGS__NOTIFICATION_CONTENTS=${PUSH__SETTINGS__NOTIFICATION_CONTENTS:="generic"}
...
export PLUGIN_SETTINGS_ENABLE_UPLOADS=${PLUGIN_SETTINGS_ENABLE_UPLOADS:=false}
